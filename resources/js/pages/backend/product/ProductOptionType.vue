...
<template>
  <AppLayout>
    <div class="p-4">
      ...
      <Link :href="route('admin.productSpec', { id: 2 })" class="border border-black rounded-sm mr-4 px-4 py-2 bg-blue-300">
        類型
      </Link>
      <Link :href="route('admin.productSpec', { id: 3 })" class="border border-black rounded-sm mr-4 px-4 py-2 hover:bg-slate-300">
        尺寸
      </Link>

      <div class="py-4">
        <button class="border border-black rounded-sm px-4 py-2 hover:bg-gray-100 my-4" type="button" @click="addType">
          新增類型
        </button>
